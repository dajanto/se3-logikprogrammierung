...
% Dateinamen zu Dateischlüssel

dateinameZuID(Dateiname,FileID) :- 

file(FileID,_,Dateiname,_,_,_). 


% Verzeichnisname zu Verzeichnisschlüssel

verzeichnisnameZuID(Verzeichnisname,DirID) :- 

directory(DirID,Verzeichnisname,_,_,_).


% Dateiname zu Name und Schlüssel des Verzeichnisses

dateinameZuDirNameUndID(Dateiname,DirName,DirID) :- 

file(_,DirID,Dateiname,_,_,_),
...
listeAllerDateinamen(DirID,DateinamenListe) :-
